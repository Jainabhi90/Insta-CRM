  ...
  const pricingPlans = {
    monthly: {
      free: {
        ...
        dms: "10 automatic DMs per automation",
        features: [
          "1 automation slot",
      ...
      pro: {
        ...
        period: "Per month",
        accounts: "1 Instagram Account",
        dms: "20 automatic DMs per automation",
        features: [
          "2 automation slots",
          "Everything in Starter",
          "Higher DM cap per rule",
      ...
      platinum: {
        ...
        period: "Per month",
        accounts: "1 Instagram Account",
        dms: "30 automatic DMs per automation",
        features: [
          "4 automation slots",
          "Everything in Pro",
          "Largest DM cap per rule",
          "Best fit for active campaigns",
          "Early access features",
          "Live support lane",
          "Higher throughput testing",
          "Growth-focused automation stack",
        ],
